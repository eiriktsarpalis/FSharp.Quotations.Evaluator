...
namespace Forked.Dynamic.Utils
{
    ...
    internal static class TypeExtensions
    {
        ...
        private readonly static PropertyInfo s_isCollectible = typeof(Type).GetProperty("IsCollectible");
        public static bool IsCollectible(this Type type) => (s_isCollectible != null) ? (bool)s_isCollectible.GetValue(type) : false;
