...
using AstUtils = Forked.Linq.Expressions.Utils;
    ...
    public sealed class ExpandoObject : IDynamicMetaObjectProvider, IDictionary<string, object>, INotifyPropertyChanged
    {
        ...
        internal bool TryGetValue(object indexClass, int index, string name, bool ignoreCase, out object value)
        {
            ...
            if (data.Class != indexClass || ignoreCase)
            {
                ...
                {
                    throw Forked.Linq.Expressions.Error.AmbiguousMatchInExpandoObject(name);
                }
            }
        ...
        internal void TrySetValue(object indexClass, int index, object value, string name, bool ignoreCase, bool add)
        {
            ...
            lock (LockObject)
            {
                ...
                {
                    throw Forked.Linq.Expressions.Error.SameKeyExistsInExpando(name);
                }
        ...
        private class KeyCollection : ICollection<string>
        {
            ...
            private void CheckVersion()
            {
                if (_expando._data.Version != _expandoVersion || _expandoData != _expando._data)
                {
                    ...
                    throw Forked.Linq.Expressions.Error.CollectionModifiedWhileEnumerating();
                }
            }
            ...
            {
                throw Forked.Linq.Expressions.Error.CollectionReadOnly();
            }
        ...
        object IDictionary<string, object>.this[string key]
        {
            get
            {
                ...
                {
                    throw Forked.Linq.Expressions.Error.KeyDoesNotExistInExpando(key);
                }
                return value;
            }
            set
